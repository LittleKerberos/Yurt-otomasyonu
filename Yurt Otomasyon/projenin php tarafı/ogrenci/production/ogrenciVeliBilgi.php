...
while( $row = sqlsrv_fetch_array($stmt, SQLSRV_FETCH_ASSOC) )
{
 ...
 <body>
   <div class="right_col" role="main">
        ...
        <div class="x_content">
           <table style=" margin-right: 75em; width:100%; background:rgb(62, 68, 82); color:white;" id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" >
                      <thead >
                        <tr>
                          <th>VELİ AD</th>
                          <th>VELİ SOYAD</th>
