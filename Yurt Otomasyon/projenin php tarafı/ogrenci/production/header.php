...
$kullanicisor = $db->prepare("SELECT * FROM ogrenci WHERE username=:username");
          ...
          <div class="left_col scroll-view">
            ...
            <div class="profile clearfix">
              ...
              <div class="profile_info">
                <span>Hoşgeldin</span>
                <h2><?php echo $kullanicicek['ogrenci_ad'];?></h2>
              </div>
              <div class="clearfix"></div>
            </div>
            <!-- /menu profile quick info -->
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <img src="https://www.erpilic.com.tr/NDC/Admin/Images/adminlogo.png" alt=""><?php echo $kullanicicek['ogrenci_ad']; ?>
