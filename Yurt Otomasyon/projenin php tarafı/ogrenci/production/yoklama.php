                ...
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <div class="x_content">
                          ...
                          <label>BİTİŞ <input type="date" name="tarih2" id="tarih2" ></label>
                          <label>VAR <input type="checkbox" name="yoklamaDurum" id="yoklamaDurum" ></label>
 ...
 <table style=" margin-right: 62em; width:95%; background:rgb(62, 68, 82); color:white;" id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" >
                      ...
                      <tbody>
                        ...
                        else
                        {
                         if (empty($durum2)) 
                         {
                           $sorgu = "SELECT * FROM tbl_yoklama WHERE tarih BETWEEN '{$tarih1}' and '{$tarih2}' and yoklamaDurum=0 and veli_id=$id";
                         }
                         else
                         {
                           $sorgu = "SELECT * FROM tbl_yoklama WHERE tarih BETWEEN '{$tarih1}' and '{$tarih2}' and yoklamaDurum=1 and veli_id=$id";
                         }
                        }                 
            $stmt = sqlsrv_query( $conn, $sorgu);   
            if($stmt === false) 
            ...
            { 
              ?>
                        <tr style="background:orange; color:white;">
                         ...
                         <td class="ortalama"><?php $durum=$row['yoklamaDurum'];
                         if ($durum==1) 
                         {
                         	echo"var";
                         }
