...
while( $row = sqlsrv_fetch_array($stmt, SQLSRV_FETCH_ASSOC) )
{
 ...
 <body>
   <div class="right_col" role="main">
        ...
        <div class="x_content">
           <table style=" margin-right: 60em; width:100%; background:rgb(62, 68, 82); color:white;" id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" >
                      <thead >
                        <tr>
                          <th>AD</th>
                          <th>SOYAD</th>
                      ...
                      <tbody>
                        ...
                        <tr style="background:orange; color:white;">
                          ...
                          <td class="ortalama"><?php echo"",date_format($row['ogr_dogumTarihi'], 'y/m/d'); ?></td>
                          <td class="ortalama"><?php echo"",$row['ogr_kanGrubu']; ?></td> 
                          <td class="ortalama"> <?php echo"",$row['ogr_il'] ?> </td>
                          <td class="ortalama"><?php echo"",$row['ogr_ilce']; ?></td>
