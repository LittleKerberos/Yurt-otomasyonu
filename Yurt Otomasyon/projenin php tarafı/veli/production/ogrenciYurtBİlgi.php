...
while( $row = sqlsrv_fetch_array($stmt, SQLSRV_FETCH_ASSOC) )
{
 ...
 <body>
   <div class="right_col" role="main">
        ...
        <div class="x_content">
           <table style=" margin-right: 85em; width:100%; background:rgb(62, 68, 82); color:white;" id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" >
                      <thead >
                        <tr>
                          <th>ODA NO</th>
                          <th>YATAK NO</th>
                      ...
                      <tbody>
                        ...
                        <?php 
                        $sorgu = "SELECT * FROM tbl_yurtbilgileri where id=$id";
						$stmt = sqlsrv_query( $conn, $sorgu);   
						if($stmt === false) 
						{
						    die( print_r( sqlsrv_errors(), true) );
                        ...
                        <tr style="background:orange; color:white;">
                          ...
                          <td class="ortalama"><?php echo"",$row['ogr_ucret']; ?></td>                                     
                        </tr>
                       <?php 
                       	}
                        ?>
